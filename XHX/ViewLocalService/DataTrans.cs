...
namespace XHX.ViewLocalService
{
    public partial class DataTrans : BaseForm
    {
        ...
        private void btnMasterDataDownLoad_Click(object sender, EventArgs e)
        {
            try
            {
                service.MasterDataDownLoad(this.UserInfoDto.UserID);
        ...
        private void btnDownLoadScoreData_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                service.ScoreDataDownLoad(CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString(), btnShopCode.Text);
        ...
        private void btnreflashSP_Click(object sender, EventArgs e)
        {
            service.syncSP("", "");
