    ...
    public partial class SpecialCaseReg : BaseForm
    {
        ...
        void txtSubjectCode_Leave(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                dto.Desc = ds.Tables[0].Rows[0]["Desc"].ToString();
            }
            if (dto == null)
            {
