...
namespace XHX.View
{
    public partial class SpecialCaseSearch : BaseForm
    {
        localhost.Service service = new localhost.Service();
        XtraGridDataHandler<SpecialCaseDto> dataHandler = null;
        GridCheckMarksSelection selection;

        public SpecialCaseSearch()
        {
            InitializeComponent();
            OnLoadView();
        }
        ...
        private void grvSpecialCase_ShowingEditor(object sender, CancelEventArgs e)
        {
            if (grvSpecialCase.FocusedColumn == gcApplyDate
                ...
                e.Cancel = true;
            if (this.UserInfoDto.RoleType == "I" && grvSpecialCase.FocusedColumn != gcView)
            {
                e.Cancel = true;
            }
        }
        ...
        private void btnView_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            SpecialCasePop pop = new SpecialCasePop(dto.SpecialCaseCode, this.UserInfoDto);
            pop.ShowDialog();
        }
        ...
        public override void SearchButtonClick()
        {
            ...
            List<SpecialCaseDto> specialCaselist_C = new List<SpecialCaseDto>();
            ...
            {
                grcSpecialCase.DataSource = specialCaselist_C;
            }
            else
            {
        ...
        {
            if(grcSpecialCase.DataSource!=null)
            CommonHandler.ExcelExport(grvSpecialCase);
        }
    }
}
